      ...
      <div className="min-h-screen bg-zinc-900">
        ...
        <header className="p-4 flex justify-between items-center sticky top-0 z-10 bg-zinc-900/90 backdrop-blur-md border-b border-zinc-800/50">
          <div className="flex items-center space-x-2">
            <span className="material-icons text-2xl text-zinc-100">
              groups
            </span>
            <Button
              variant="ghost"
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            <span className="font-mono text-2xl font-bold text-zinc-100 tracking-wider">
              IWS
            </span>
          </div>
          ...
          {gos.map((go) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-5">
                  <h2
                    className="text-lg font-semibold text-zinc-100 mb-3 truncate"
                    title={go.title}
                  >
                    {go.title}
                  </h2>
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between text-xs text-zinc-300 mb-1.5">
                      <span>
                        Participants: {go.currentParticipants}/
                        {go.maxParticipants}
                      </span>
