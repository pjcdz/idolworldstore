    ...
    return (
      <button
        ...
        className={`bg-green-500 hover:bg-green-600 text-white p-2 rounded-full 
          ...
          shadow-lg hover:shadow-green-500/40 focus:outline-none focus:ring-2 
          focus:ring-green-400/50 ${className}`}
  ...
  return (
    <button
      ...
      className={`w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700
        ...
        transform hover:scale-[1.03] active:scale-95 shadow-lg hover:shadow-green-500/40 
        focus:outline-none focus:ring-2 focus:ring-green-400/50 ${className}`}
    >
