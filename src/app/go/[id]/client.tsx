...
interface GODetailClientProps {
  goId: string;
}

// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function GODetailClient({ goId: _ }: GODetailClientProps) {
  // TODO: Use goId to fetch the specific GO data instead of mock data
